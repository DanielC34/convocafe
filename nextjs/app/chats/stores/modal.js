...
export const useModalStore = create((set) => ({
    isOpen: false,
    modal : null,
    openAddGroupModal: () => set({isOpen: true, modal: <AddGroupUserModel onClose={() => set({isOpen: false})} />}),
    openAddUserModal: () => set({isOpen: true, modal: <AddUserModal onClose={() => set({isOpen: false})} />}),
